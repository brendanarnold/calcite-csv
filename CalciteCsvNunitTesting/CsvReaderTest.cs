...
namespace CalciteCsvNunitTesting
{
    ...
    public class CsvReaderTest
    {
        ...
        public void SplitLineTestBasic()
        {
            ...
            StreamReader stream = new StreamReader(Variables.TabSeparatedFileBasicDosFilename);
        ...
        public void SplitLinesFixedWidthTest()
        {
            ...
            StringReader stringStream = new StringReader(Variables.TabSeparatedFileBasicDosFilename);
            string line = "flim   flam flop";
        ...
        public void ResetTest()
        {
            ...
            stream = new StreamReader(Variables.TabSeparatedFileBasicUnixFilename);
